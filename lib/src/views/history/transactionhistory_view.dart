                  ...
                  context.read<HistoryViewModel>().toTransactionDetail(
                        ArgsTransactionDetailHelper(
                          transaction: TransactionModel(
                              ...
                              category: value.transactionList[index].category,
                              name: value.transactionList[index].name,
                              price: value.transactionList[index].price,
                              image: value.transactionList[index].image,
                              serialNumber:
                                  value.transactionList[index].serialNumber,
                              identifierNumber:
                                  value.transactionList[index].identifierNumber,
                              date: value.transactionList[index].date,
                              status: value.transactionList[index].status),
                        ),
                      );
                },
                child: Container(
